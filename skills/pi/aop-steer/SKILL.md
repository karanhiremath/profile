...
When the user scopes to **EOP / MK / KH sprint planning**, stop and use
`work-sprint-planning`. Voice, Headscale, and Hermes runtime are orthogonal.
Stay read-only. Do not `--apply` from a sprint-planning session.
